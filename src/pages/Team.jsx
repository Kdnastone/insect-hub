        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <section className="bg-white shadow-lg rounded-lg p-6">
            ...
            <p className="text-[#475C22] leading-relaxed text-justify mb-4">
              ...
              herramientas interactivas y accesibles. Esta sinergia nos permite crear soluciones que no solo informan, sino que también educan, inspiran y conectan a distintos 
